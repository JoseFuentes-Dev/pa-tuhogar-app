...
const Navbar = () => {
    ...
    return (
        <nav className='menu-principal bg-[#008DDA] w-full h-20 flex justify-between pr-5 items-center '>
            {/* Logo */}
            <img src={logo} alt="Pa' tu hogar logo" className='w-50 h-20' />
            ...
            <ul className={`z-40 flex flex-col items-center md:flex-row md:items-center text-white md:static absolute bg-[#008DDA] md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-9 transition-all duration-500 ease-in-out ${isOpen ? 'top-20' : 'top-[-490px]'}`}>
